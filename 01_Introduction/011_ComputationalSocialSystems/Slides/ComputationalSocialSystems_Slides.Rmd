...
- 14.10.2021, 5pm: Supplementary lecture at **Computer Science Faculty Day**
...
Handouts, codes, and data can be found on the Github repository of the course. Exercises are based on the R statistical language with RStudio.

Foundations of CSS Discord (only this course): https://discord.com/invite/HSCFE8fAdx
...
- Can be linked to project in Introduction to CSS. Great opportunity to start working together on a publishable paper or follow-up project in the programme
...
- The project grade is a combination:
  - ten-minute presentation (50%)
  - six-page written report on the project (50%).

- Extra points (max 20%) can be achieved by delivering two optional exercise solutions: 
